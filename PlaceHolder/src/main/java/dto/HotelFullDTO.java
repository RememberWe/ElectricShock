...
public class HotelFullDTO {
	...
	public HotelFullDTO(String hotelId, String hotelName, String hotelInfo, String hotelPhone, String hotelRoadAddress,
			String hotelLongitude, String hotelLatitude, String hotelScore, String hotelDetail, String hotelImg,
			boolean listLike) {
		super();
		this.hotelId = hotelId;
		this.hotelName = hotelName;
