<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <link rel="stylesheet" href="/semi-css/articleWrite.css">
    </head>
              ...
              <div class="container">
                <div class="row title">
                  <div class="col title" style="text-align: center;">
                    <br> <br><input type="text" id="postTitle" name="postTitle" placeholder="제목을 입력하세요">
                  </div>
                </div>
                <br>
                <div class="row content">
                  <div class="col content" style="text-align: center;">
                    <textarea id="postContent" rows="20" cols="100" name="postContent"></textarea>
                  </div>
                </div>
                <div class="row button">
                  <div class="col button" style="text-align: right;">
                    ...
                    <input type=reset values="초기화" class="writeBtns"> <button class="writeBtns">글 작성</button>
                  </div>
                </div>
              </div>
            </form>
