...
<link rel="shortcut icon" type="image/x-icon" href="/semi-img/favicon.ico" />
    ...
    <body>
      ...
      <div class="container">
		...
		<!-- 내용물 -->
        <form action ="/modify.qna" method="get" id = "frmDetail">
        	<div class = "container">
        	<div class = "row title">
        		<div class = "col title">
        			<br>
        			<br>
        			<input type=hidden value = "${inquiryList.inquiry }" name = inquiry id = inquiry>
        		</div>
        	</div>
        	<div class = "row sub">
        		<div class = "col-6 sub">
        		...
        		<div class = "col-3 sub" style = "text-align : center">
        			<label>작성일 : </label>
        			${inquiryList.inquiryCreated}
        		</div>
        	</div>
        	<br>
        	<div class = "row content">
        		<div class = "col content">
        			<textarea rows = "25" cols = "110" name = "inquiryContent" id = "content" readonly>${inquiryList.inquiryContent }</textarea>
        		</div>
        	</div>
        	<div class = "row button">
        		<div class = "col button" style = "text-align:right;">
        			<a href="javascript:history.back()">
        				<input type = "button" class="writeBtns" value = "목록으로"></a>
        			<c:if test = "${inquiryList.userId == loginId }">
        				<input type = button id="del" value = "삭제" class="writeBtns" style = "width : 60px;" id = "del">
        				<input type = button id="mod" value = "수정" class="writeBtns" style = "width : 60px;" id = "mod">
        				<input type = button id = "modOk" class="writeBtns" style = "display:none;" value = "수정완료">
						<input type = button id = "modCancel" class="writeBtns" style = "display:none;" value = "취소">
					</c:if>
        		</div>
        	</div>
        </div>
