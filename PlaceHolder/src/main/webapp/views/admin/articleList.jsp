...
<body>
	...
	<div class="container">
				...
				<div class="container" style="text-align: center;">
					...
					<c:forEach var="list" items="${articleList}">
						<div class="row"
							...
							<span style = "width:15%;" class="col-2 userId">${list.postId}</span>
							<span style = "width:20%;">${list.userId}</span>
							<span style = "width:40%; overflow:hidden; white-space:nowrap; text-overflow:ellipsis;">
								<a href="detail.article?postId=${list.postId}"
									style="text-decoration-line: none;">${list.postTitle}</a>
							</span>
							<span style = "width:25%;">${list.postCreated}
     ...
     //검색어 입력했을 때
        ...
        location.href = "/articleSearch.admin?option=" + searchOption + "&Keyword=" + searchTxt; // get으로 검색값 전달
        })
