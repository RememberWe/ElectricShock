				...
				<div class="container" style="text-align: center;">
					...
					<c:forEach var="list" items="${userList}">
						<div class="row"
							...
							<span class="userId" style = "width: 15%;">${list.userId}</span>
							<span style="width: 15%; overflow-x:auto;">${list.userName}</span>
							<span style = "width:20%; overflow-x:auto;" >${list.userNickname}</span>
							<span style = "width: 25%; overflow-x:auto;">${list.userEmail}</span>
							<span style = "width:25%;">${list.userPhone}
